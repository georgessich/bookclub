...
exports.isImplicitlyInstallablePlugin = exports.internalExecuteOperation = exports.ApolloServer = void 0;
    ...
    async executeHTTPGraphQLRequest({ httpGraphQLRequest, context, }) {
        try {
            ...
            if (runningServerState.landingPage &&
                ...
                return {
                    headers: new runHttpQuery_js_1.HeaderMap([['content-type', 'text/html']]),
            ...
            try {
                ...
                const status = error instanceof graphql_1.GraphQLError &&
                    error.extensions.code &&
                    error.extensions.code !== index_js_1.ApolloServerErrorCode.INTERNAL_SERVER_ERROR
                    ? 400
                    : 500;
                return this.errorResponse(error, (0, runHttpQuery_js_1.newHTTPGraphQLHead)(status));
            }
            ...
            if (maybeError instanceof graphql_1.GraphQLError &&
                ...
                return this.errorResponse(maybeError, maybeError.message === runHttpQuery_js_1.badMethodErrorMessage
                    ? {
                        status: 405,
                        headers: new runHttpQuery_js_1.HeaderMap([['allow', 'GET, POST']]),
                    }
                    : (0, runHttpQuery_js_1.newHTTPGraphQLHead)(400));
            }
            return this.errorResponse(maybeError);
        }
    }
    errorResponse(error, httpGraphQLHead = (0, runHttpQuery_js_1.newHTTPGraphQLHead)()) {
        return {
...
async function internalExecuteOperation({ server, graphQLRequest, contextValue, internals, schemaDerivedData, }) {
    const httpGraphQLHead = (0, runHttpQuery_js_1.newHTTPGraphQLHead)();
    ...
    const requestContext = {
        ...
        contextValue: (0, runHttpQuery_js_1.cloneObject)(contextValue),
        metrics: {},
        overallCachePolicy: (0, cachePolicy_js_1.newCachePolicy)(),
    };
    try {
        await (0, requestPipeline_js_1.processGraphQLRequest)(schemaDerivedData, server, internals, requestContext);
    }
    catch (maybeError) {
        const error = (0, errorNormalize_js_1.ensureError)(maybeError);
